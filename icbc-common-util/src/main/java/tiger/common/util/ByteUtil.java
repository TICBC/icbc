...
public final class ByteUtil {
     ...
     *
     * @param buf    字节数组
     * @param offset 需要转换的有效字节起始偏移量
     * @param length 需要转换的字节长度
     * @param asc    标记数值字节存放顺序
     * @return 长整型数值
     */
     ...
     * 将boolean转换为byte
     *
     * @param b boolean， 为true时转换为1，fasle时转换为0
     * @return byte
     */
     ...
     * 两个字节数组长度必须一致
     *
     * @param src    源字节数组, 执行'位或'之后的值将保存到该数组内
     * @param other  另一个字节数组
     * @param offset 起始偏移量
     */
     ...
     *
     * @param src         源字节数组, 执行'位或'之后的值将保存到该数组内
     * @param srcOffset   源字节数组中的起始偏移量
     * @param other       另一个字节数组
     * @param otherOffset 另一个字节数组的起始偏移量
     * @param length      需要执行操作的字节长度
     */
